...
module Hyrax
  ...
  class GoogleScholarPresenter < Draper::Decorator
    ...
    def scholarly?
      responds = object.respond_to? :scholarly?
      puts "GoogleScholarPresenter: object is #{object.id}" # this works
      puts "GoogleScholarPresenter: object.respond_to? :scholarly? is #{responds}" # I get 'false'
