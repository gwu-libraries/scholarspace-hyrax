Hyrax.config do |config|
  ...
  # Injected via `rails g hyrax:work GwJournalIssue`
  ...
  config.contact_email = "schol_comm@gwu.edu"
  ...
  config.temp_file_base = '/Users/alexander.boyd/Documents/repos/scholarspace-hyrax/tmp/tmp-files'
  ...
  config.fits_path = "/Users/alexander.boyd/Applications/fits-1.5.0/fits.sh"
